# Desktop Template with UI

![Build Status](https://github.com/robrohan/desktop-template-ui/actions/workflows/build.yml/badge.svg)

The most minimal, self contained, C99 based, cross platform (Linux, Windows,
MacOS) desktop UI application template I could find / put together.
